...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').each(function() {
        ...
        tjq(this).datepicker({
            showOn: 'button',
            buttonImage: 'http://images.travellers-palm.com/icon/blank.png',
            buttonText: '',
...
tjq(window).load(function() {
    ...
    tjq(".mobile-menu ul.menu > li.menu-item-has-children").each(function(index) {
        ...
        tjq("#" + menuItemId).on("show.bs.collapse", function() {
            tjq(this).parent().addClass("open");
            // document.getElementById('page-title').visibility = 'hidden';
        });
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travellers-palm - home" href="/"><img alt="Travellers Palm" src="http://images.travellers-palm.com/about-us/logo-gold.png" width="350px"></a></h1>').insertBefore('.chaser .menu');
